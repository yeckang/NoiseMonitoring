...
if __name__ == '__main__' :
    ...
    print ("The result has saved in %s/sbit_threshold_scan.root"%dirName)
    print ("Finding threshold for the time scan")
    make_threshold_file(dirName, args.rate_value)
    print ("The threshold for time scan has saved in %s/threshold.txt")
    exit()
